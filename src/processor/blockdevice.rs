...
pub async fn process_blockdevice_data(proc_data: &ProcData, statistics: &mut HashMap<(String, String, String), Statistic>) -> Result<()> {
...
pub async fn add_blockdevices_to_history(statistics: &HashMap<(String, String, String), Statistic>) -> Result <()> {
    ...
    for disk_name in disk_list.iter().filter(|disk_name| !disk_name.starts_with("loop") & !disk_name.starts_with("sr")) {
        ...
        let reads_time_spent_ms = statistics.get(&("blockdevice".to_string(), disk_name.to_string(), "stat_reads_time_spent_ms".to_string()))
        ...
        let writes_bytes = statistics.get(&("blockdevice".to_string(), disk_name.to_string(), "stat_writes_sectors".to_string()))
            .ok_or(ProcessorError::UnableToFindKeyInHashMap { hashmap: "statistics".to_string(), key1: "blockdevice".to_string(), key2: disk_name.to_string(), key3: "stat_writes_wectors".to_string() })?.per_second_value * 512_f64; // convert 512 bytes sector writes to bytes
        totals[6] += writes_bytes;
        let writes_time_spent_ms = statistics.get(&("blockdevice".to_string(), disk_name.to_string(), "stat_writes_time_spent_ms".to_string()))
        ...
        // ios
        let ios_in_progress = statistics.get(&("blockdevice".to_string(), disk_name.to_string(), "stat_ios_in_progress".to_string()))
            .ok_or(ProcessorError::UnableToFindKeyInHashMap { hashmap: "statistics".to_string(), key1: "blockdevice".to_string(), key2: disk_name.to_string(), key3: "stat_ios_in_progress".to_string() })?.per_second_value;
        totals[8] += ios_in_progress;
        let ios_time_spent_ms = statistics.get(&("blockdevice".to_string(), disk_name.to_string(), "stat_ios_time_spent_ms".to_string()))
            .ok_or(ProcessorError::UnableToFindKeyInHashMap { hashmap: "statistics".to_string(), key1: "blockdevice".to_string(), key2: disk_name.to_string(), key3: "stat_ios_time_spent_ms".to_string() })?.per_second_value;
        totals[9] += ios_time_spent_ms;
        let ios_weighted_time_spent_ms = statistics.get(&("blockdevice".to_string(), disk_name.to_string(), "stat_ios_weighted_time_spent_ms".to_string()))
            .ok_or(ProcessorError::UnableToFindKeyInHashMap { hashmap: "statistics".to_string(), key1: "blockdevice".to_string(), key2: disk_name.to_string(), key3: "stat_ios_weighted_time_spent_ms".to_string() })?.per_second_value;
        ...
        let discards_bytes = statistics.get(&("blockdevice".to_string(), disk_name.to_string(), "stat_discards_sectors".to_string()))
            .ok_or(ProcessorError::UnableToFindKeyInHashMap { hashmap: "statistics".to_string(), key1: "blockdevice".to_string(), key2: disk_name.to_string(), key3: "stat_discards_sectors".to_string() })?.per_second_value * 512_f64; // convert 512 sectors discards to bytes
        totals[13] += discards_bytes;
        let discards_time_spent_ms = statistics.get(&("blockdevice".to_string(), disk_name.to_string(), "stat_discards_time_spent_ms".to_string()))
        ...
        // flushes
        let flush_requests_completed_success = statistics.get(&("blockdevice".to_string(), disk_name.to_string(), "stat_flush_requests_completed_success".to_string()))
            .ok_or(ProcessorError::UnableToFindKeyInHashMap { hashmap: "statistics".to_string(), key1: "blockdevice".to_string(), key2: disk_name.to_string(), key3: "stat_flush_requests_completed_success".to_string() })?.per_second_value;
        totals[15] += flush_requests_completed_success;
        let flush_requests_time_spent_ms = statistics.get(&("blockdevice".to_string(), disk_name.to_string(), "stat_flush_requests_time_spent_ms".to_string()))
            .ok_or(ProcessorError::UnableToFindKeyInHashMap { hashmap: "statistics".to_string(), key1: "blockdevice".to_string(), key2: disk_name.to_string(), key3: "stat_flush_requests_time_spent_ms".to_string() })?.per_second_value;
        ...
        let queue_max_sectors_kb = statistics.get(&("blockdevice".to_string(), disk_name.to_string(), "queue_max_sectors_kb".to_string()))
        ...
        let queue_max_hw_sectors_kb = statistics.get(&("blockdevice".to_string(), disk_name.to_string(), "queue_max_hw_sectors_kb".to_string()))
        ...
        let dev_block_major = statistics.get(&("blockdevice".to_string(), disk_name.to_string(), "dev_block_major".to_string()))
            .ok_or(ProcessorError::UnableToFindKeyInHashMap { hashmap: "statistics".to_string(), key1: "blockdevice".to_string(), key2: disk_name.to_string(), key3: "dev_block_major".to_string() })?.last_value;
        let dev_block_minor = statistics.get(&("blockdevice".to_string(), disk_name.to_string(), "dev_block_minor".to_string()))
            .ok_or(ProcessorError::UnableToFindKeyInHashMap { hashmap: "statistics".to_string(), key1: "blockdevice".to_string(), key2: disk_name.to_string(), key3: "dev_block_minor".to_string() })?.last_value;
        let removable = statistics.get(&("blockdevice".to_string(), disk_name.to_string(), "removable".to_string()))
            .ok_or(ProcessorError::UnableToFindKeyInHashMap { hashmap: "statistics".to_string(), key1: "blockdevice".to_string(), key2: disk_name.to_string(), key3: "removable".to_string() })?.last_value;
        let ro = statistics.get(&("blockdevice".to_string(), disk_name.to_string(), "ro".to_string()))
            .ok_or(ProcessorError::UnableToFindKeyInHashMap { hashmap: "statistics".to_string(), key1: "blockdevice".to_string(), key2: disk_name.to_string(), key3: "ro".to_string() })?.last_value;
        let queue_rotational = statistics.get(&("blockdevice".to_string(), disk_name.to_string(), "queue_rotational".to_string()))
            .ok_or(ProcessorError::UnableToFindKeyInHashMap { hashmap: "statistics".to_string(), key1: "blockdevice".to_string(), key2: disk_name.to_string(), key3: "queue_rotational".to_string() })?.last_value;
        let queue_dax = statistics.get(&("blockdevice".to_string(), disk_name.to_string(), "queue_dax".to_string()))
            .ok_or(ProcessorError::UnableToFindKeyInHashMap { hashmap: "statistics".to_string(), key1: "blockdevice".to_string(), key2: disk_name.to_string(), key3: "queue_dax".to_string() })?.last_value;
        let queue_hw_sector_size = statistics.get(&("blockdevice".to_string(), disk_name.to_string(), "queue_hw_sector_size".to_string()))
            .ok_or(ProcessorError::UnableToFindKeyInHashMap { hashmap: "statistics".to_string(), key1: "blockdevice".to_string(), key2: disk_name.to_string(), key3: "queue_hw_sector_size".to_string() })?.last_value;
        let queue_logical_block_size = statistics.get(&("blockdevice".to_string(), disk_name.to_string(), "queue_logical_block_size".to_string()))
            .ok_or(ProcessorError::UnableToFindKeyInHashMap { hashmap: "statistics".to_string(), key1: "blockdevice".to_string(), key2: disk_name.to_string(), key3: "queue_logical_block_size".to_string() })?.last_value;
        let queue_nomerges = statistics.get(&("blockdevice".to_string(), disk_name.to_string(), "queue_nomerges".to_string()))
            .ok_or(ProcessorError::UnableToFindKeyInHashMap { hashmap: "statistics".to_string(), key1: "blockdevice".to_string(), key2: disk_name.to_string(), key3: "queue_nomerges".to_string() })?.last_value;
        let queue_physical_block_size = statistics.get(&("blockdevice".to_string(), disk_name.to_string(), "queue_physical_block_size".to_string()))
            .ok_or(ProcessorError::UnableToFindKeyInHashMap { hashmap: "statistics".to_string(), key1: "blockdevice".to_string(), key2: disk_name.to_string(), key3: "queue_physical_block_size".to_string() })?.last_value;
        let queue_read_ahead_kb = statistics.get(&("blockdevice".to_string(), disk_name.to_string(), "queue_read_ahead_kb".to_string()))
            .ok_or(ProcessorError::UnableToFindKeyInHashMap { hashmap: "statistics".to_string(), key1: "blockdevice".to_string(), key2: disk_name.to_string(), key3: "queue_read_ahead_kb".to_string() })?.last_value;
        let queue_discard_max_hw_bytes = statistics.get(&("blockdevice".to_string(), disk_name.to_string(), "queue_discard_max_hw_bytes".to_string()))
            .ok_or(ProcessorError::UnableToFindKeyInHashMap { hashmap: "statistics".to_string(), key1: "blockdevice".to_string(), key2: disk_name.to_string(), key3: "queue_discard_max_hw_bytes".to_string() })?.last_value;
        let queue_discard_max_bytes = statistics.get(&("blockdevice".to_string(), disk_name.to_string(), "queue_discard_max_bytes".to_string()))
            .ok_or(ProcessorError::UnableToFindKeyInHashMap { hashmap: "statistics".to_string(), key1: "blockdevice".to_string(), key2: disk_name.to_string(), key3: "queue_discard_max_bytes".to_string() })?.last_value;
...
) -> Result<()>
{
    ...
    if output == "sar-b" {
        ...
        for disk_name in disk_list {
            ...
            discards_average_time = if discards_average_time.is_nan() { 0_f64 } else { discards_average_time };
